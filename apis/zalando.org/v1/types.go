...
const (
	...
	LeastRequestsBackendAlgorithm         BackendAlgorithmType = "leastRequests"
)
...
type RouteGroupBackend struct {
	...
	// +kubebuilder:validation:Enum=roundRobin;random;consistentHash;powerOfRandomNChoices;weightedRoundRobin;leastRequests
	// +optional
